...
\sdefinition{Cellula procariota}{
    Le \textit{cellule procariote} sono cellule prive di un nucleo ben
    definito e delimitato dalla membrana nucleare.
}

\sdefinition{Cellula eucariota}{
    Le \textit{cellule eucariote} sono cellule
    che possiedono un nucleo circondato da una membrana,
    organuli anch'essi racchiusi da membrane
    e un sistema di membrane interne.
}
