...
\subsection{Glucotrasportatori di membrana (Glut4)}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.75\textwidth]{./omeostasi.png}
\end{figure}

\pagebreak

% https://tikzcd.yichuanshen.de/#N4Igdg9gJgpgziAXAbVABwnAlgFyxMJZAFgBoBGAXVJADcBDAGwFcYkQAdDnGADxwBGAM2ABBHHloQAviGml0mXPkIoAbBWp0mrdlx79hwAAr042KbPmLseAkQDMpAExaGLNok7c+OEwCcsAFt6QIgAAgAKUQAVYwBKKwUQDFsVIgBWFzcdT28DPwBlGABjAihQ-CSbZXsUMgccjz0ffmAAVTAsDH8cGTlk1NrVZCzGmnddL31fYELgnr7qlKU7EY1x7Wbp1r9RMDxF-usVtLrkDWImqZABmrXM0iuJ3PY70+GiMmetm-ehh4oAAcmhe23yswAIlghEJmNgCDBlgD0igAJzZME3GZtYpBNCMLAlJH-Vao5AAdkxvzyOL8ADF6CUsIScPQ2ciyecqZtJrTdsASvQwEwsJyziMMbzXjsCsAgjAggJ-ML6OLPvVSAAGa78gpGGIquCLdkQQLqwHIZygmktfUiABq8GZZUYoRJJxR53I2t1dtmAFEwFAIMy+tgLeSfa4sXrA3BQ7glJHzlqbXz-W0AOIq4NYcJofwQHhYMAewZckY+6Xgum4YABuAAOnC0nCdOAWZYOGIVi0MCgAHN4ERQEIi0EkGmQH0kM4TuOIJPENPZ4gHAuJ0gnDOIEhe8lF8ud2uMpul9uaGu1Ofl1ld-
%\begin{tikzcd}
%    & \text{Endocitosi}                                                                          &                                            &                       & \textbf{Trasportatori} \arrow[d, "\text{Contro Gradiente}"'] \arrow[rrd, "\text{Per Gradiente}"', bend left] \arrow[lld, bend right] &                                                                                 &                                        &                             &                                         &                           \\
%\text{Grandi proteine} \arrow[rr, two heads, dashed, tail] &                                                                                            & \textbf{Vescicolare} \arrow[lu] \arrow[ld] &                       & \textbf{Attivo} \arrow[ld] \arrow[rd]                                                                                                &                                                                                 & \textbf{Passivo} \arrow[rr]            &                             & \text{Diffusione} \arrow[rd] \arrow[ld] &                           \\
%    & \text{Esocitosi}                                                                           &                                            & \text{Primario (ATP)} &                                                                                                                                      & \text{Secondario} \arrow[ld] \arrow[d] \arrow[rd]                               &                                        & \text{Facilitata} \arrow[d] &                                         & \text{Semplice} \arrow[d] \\
%    & \textit{Es. } \text{Glut4} \arrow[ruu, "\textbf{passivo}" description, dotted, bend right] &                                            &                       & \text{Uniporto} \arrow[d]                                                                                                            & \text{Simporto} \arrow[l, "\text{sfrutta}", bend left=49] \arrow[d, Rightarrow] & \text{Antiporto} \arrow[d, bend right] & \text{canali}               &                                         & \text{membrana}           \\
%    &                                                                                            &                                            &                       & {}                                                                                                                                   & {}                                                                              & {} \arrow[u, bend right]               &                             &                                         &                          
%\end{tikzcd}
