...
\sdefinition{Principio di esclusione competitiva}{
...
\subsection{Il ciclo del carbonio}

\sdefinition{Serbatoio abiotico}{
...
Il carbonio si trova principalmente nelle roccie e negli oceani.

\begin{center}
\begin{figure}[th]
    \centering
    \includegraphics[width=0.6\textwidth]{./ciclo_biogeochimico.png}
\end{figure}
\end{center}
