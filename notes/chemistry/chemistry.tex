...
\subsection{Semireazioni}

\sdefinition{Semireazioni}{
...
\sexercise{Scrivi le semireazioni di ossidoriduzione}{
    Data la reazione
    \[
...
\sexercise{la combustione del metano è una reazione di ossidoriduzione?}{
    ...
    \end{align*}
    Di conseguenza \(C\) si ossida e \(O\) si riduce.
}
...
\sexercise{Stechiometrica e reazione di ossi-riduzione}{
