...
\begin{itemize}
    \item Una teoria del secolo scorso lega ragioni culturali al sottosviluppo;
    \item un'altra indica che clima caldo, suolo arido, morgologia difficile,
...
% leggi p 156-158 del libro Elementi di geografia per le scuole medie superiori.
% Riassumi brevmeente le diverse interpretazioni dello sviluppo presentate (eventualmente anche in maniera schematica se lo ritieni necessario)
...
Fra i due tropici è presente una \textit{zona di convergenza tropicale}.
