...
\begin{center}
    \textit{la conoscenza dele azioni degli uomini grandi}
\end{center}
...
Il vantaggio di un dono simile è che un libro è una sintesi di migliaia di pagine lette e 15 anni di esperienza.
