...
quella con la donna siciliana nel chhiassetto (§§1-55), quella del pozzo (§§56-70)
ed infine quella della chiesa (§§71-89).
Le tre avventure sono ambientate in luoghi distinti e stretti,
...
TODO...
% sspazi: perugia-perugia
% albero, mercato, casa siciliana, vie di napoli, chiesa

% code vere:
% Napoli non era una cità sicura; la morte del vescovo anche se in altri tempi; commercio di cavalli
% i personaggi sono anche probabilimente veramente esistiti. Chiaramente, anche i luoghi Napoletani (ruga ctalana e ...)
% sono posti reali.

% La novella di Andreuccio ricorda ua fiaba ed un romanzo di formazione
% Questo romanzo di formazione porta Andreuccio a crescere, portando a casa una maggiore astuzia e anche più fortuna di
% qunata non ne avesse all'inizio, per cui Andreuccio acquista il pensiero di un mercante.
...
% Sia la prostituta che i ladri che andreuccio guadagno qualcosa di materiale. Tutti ci guadagnano qualcosa
